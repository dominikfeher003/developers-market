          ...
          <SignIn
            appearance={{
              ...
              elements: {
                ...
                formFieldInput: "!border-zinc-700 !text-white !bg-zinc-900 focus:!border-indigo-500",
                ...
                verificationLinkStatusText: "!text-zinc-300",
                verificationLinkStatusBox: "!bg-zinc-900 !border-zinc-700",
                otpCodeFieldInput: "!border-zinc-700 !text-white !bg-zinc-900",
                resendCodeLink: "!text-indigo-400 hover:!text-indigo-300",
                alternativeMethodsBlockButton: "!border-zinc-700 !text-zinc-300 hover:!bg-zinc-800",
                formResendCodeLink: "!text-indigo-400 hover:!text-indigo-300",
                // General text
                bodySmallText: "!text-zinc-400",
